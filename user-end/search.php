    ...
    <section id="food">
      <div class="container-fluid padding">
        <div class="row text-center padding">
          <div class="col-12">
            <h1 class="Display-4">Serch Result for: <?php echo$search; ?></h1>
          </div>
        </div>
      </div>
      <hr>
      ...
      <div class="container-fluid padding">
        ...
        <?php
         ...
         $sql1 ="Select * from food where name like '%$search%'";
        ...
        //sql
        $sql="Select * from food where name like '%$search%'  LIMIT  $st_limit_no,$results_per_page";
        ...
        <div class="row text-center padding">
          <div class="col-12">
            <nav aria-label="Page navigation example" >
              ...
              <?php
                if ($page>1){
                echo "<li class='page-item'><a class='page-link' href='search.php?search=$search&page=".($page-1)."'>Previous</a></li>";
                }  
