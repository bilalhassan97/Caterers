 ...
 <nav class="navbar navbar-expand-md navbar-light bg-ligth sticky-top">
      <div class="container-fluid">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a class="item-active">Order History</a>
                        ...
                        <table id="mytable" class="table table-bordred table-striped">
                            ...
                            <tbody>
                                <?php
                                     ...
                                     //sql
                                     $sql= "SELECT * FROM `order` join `user` on order.u_id = user.u_id LIMIT  $st_limit_no,$results_per_page";
                                     $result = mysqli_query($con,$sql);
                                ...
                                ?>
                                <tr>
                                    <td> <?php  echo $arr['or_id'];?> </td>
                                    <td> <?php  echo $arr['f_name'];?> </td>
                                    <td> <?php  echo $arr['l_name'];?> </td>
                                    <td> <?php  echo $arr['address'];?> </td>
                                    <td> <?php  echo  date('M j Y g:i A',strtotime($arr['time']));?> </td>

                                    <td> <strong>Rs.</strong> <?php  echo $arr['total_price'];?></td>
                                    <td>
                                        <form action="view-order-details.php?='<?php echo $arr['or_id'];?>'">
                                            <button type="submit" class="btn btn-secondary btn-xs" name="or_id" value="<?php echo $arr['or_id']?>"> View
                                                Details</button>
                                        </form>
                                    </td>
                                </tr>
        ...
        <div class="row text-center padding">
          <div class="col-12">
            <nav aria-label="Page navigation example" >
              ...
              <?php
                if ($page>1){
                echo "<li class='page-item'><a class='page-link' href='user-order-history.php?page=".($page-1)."'>Previous</a></li>";
                }  
                for($i=1;$i<=$number_of_pages;$i++){
                echo "<li class='page-item'><a class='page-link' href='user-order-history.php?page=".$i."'>$i</a></li>";
                }
                if ($i-1>$page){
                echo "<li class='page-item'><a class='page-link' href='user-order-history.php?page=".($page+1)."'>Next</a></li>";
                }
               ?>
              </ul>
            </nav>
