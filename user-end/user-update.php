                    ...
                    <div class="col-sm-12 col-md-8 text-center">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td>
                                    <input class="form-control" type="text" name="updated_first_name" id="u_fname"
                                        placeholder="First Name e.g: Muhammad" autofocus>
                                    
                                    <input class="form-control" type="text" name="updated_last_name" id="u_lname"
                                        placeholder="Last Name e.g: Tiwana">
                                </td>
                            </tr>
                            <tr>
                                <td scope="row"></td>
                                ...
                                <td>
                                    <input class="form-control" type="email" name="updated_email" id="u_email"
                                        placeholder="e-mail e.g: abc@gmail.com">
                                </td>
                            </tr>
                            <tr>
                                <td scope="row"></td>
                                ...
                                <td>
                                    <p><?php echo '0'.$_SESSION['contact']?></p>
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="updated_contact" id="u_contact"
                                        placeholder="11 digit Contact No. e.g: 03331234567" pattern="[0][3][0-9]{9}"
                                        title="Contact No. Should start with '03' and must have total of 11 digits">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="form-control" type="password" name="updated_password" id="u_password"
